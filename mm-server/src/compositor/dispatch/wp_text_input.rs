...
impl wayland_server::Dispatch<zwp_text_input_manager_v3::ZwpTextInputManagerV3, ()> for State {
    fn request(
        state: &mut Self,
        _client: &wayland_server::Client,
...
impl wayland_server::Dispatch<zwp_text_input_v3::ZwpTextInputV3, ()> for State {
    fn request(
        _state: &mut Self,
        _client: &wayland_server::Client,
